    ...
    <div class="max-w-7xl mx-auto px-4 py-4 sm:px-6 lg:px-8">
      <div class="flex items-center justify-between h-16">
        ...
        <div class="hidden md:flex space-x-1">
          ...
          class="flex">
              <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 mx-2 text-gray-500 hover:text-green-900" viewBox="0 0 60 60" fill="currentColor" stroke-width="2">
          ...
          rel="noopener noreferrer"
          class="flex">
              <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 mx-2 text-gray-500 hover:text-green-900 -mt-1" viewBox="0 0 60 60" fill="currentColor" stroke-width="2">
